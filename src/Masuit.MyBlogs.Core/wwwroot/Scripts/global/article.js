...
function commentVoteBind() {
    $(".cmvote").on("click", function (e) {
        window.post("/comment/" + $(this).data("id") + "/Vote", null, function (data) {
            if (data) {
                if (data.Success) {
...
function bindVote() {
    $("#voteup").on("click", function (e) {
        window.post("/post/voteup/" + $("#postId").val(), null, function (data) {
            if (data) {
                if (data.Success) {
    ...
    $("#votedown").on("click", function (e) {
        window.post("/post/votedown/" + $("#postId").val(), null, function (data) {
            if (data) {
                if (data.Success) {
